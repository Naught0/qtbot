...
"""
This entire segment taken DIRECTLY from:
https://github.com/Rapptz/RoboDanny/blob/master/cogs/buttons.py
Thanks to Danny for figuring out how to scrape Google better than
I had the patience to do.
His bot is MIT Licensed, the full text of which can be found here:
https://github.com/Rapptz/RoboDanny/blob/master/LICENSE.txt
"""
    ...
    async def get_google_entries(self, query):
        ...
        async with aiohttp.get('https://www.google.com/search', params=params, headers=headers) as resp:
            ...
            for node in search_nodes:
                ...
                # get the URL from ?q query string
